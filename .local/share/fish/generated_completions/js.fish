...
complete -c js -l inspect-brk --description 'Activate inspector on host:port and break at st… [See Man Page]'
...
complete -c js -l napi-modules --description 'Enable loading native modules compiled with the… [See Man Page]'
complete -c js -l abort-on-uncaught-exception --description 'Aborting instead of exiting causes a core file … [See Man Page]'
complete -c js -l trace-warnings --description 'Print stack traces for process warnings (includ… [See Man Page]'
complete -c js -l redirect-warnings --description 'Write process warnings to the given file instea… [See Man Page]'
complete -c js -l trace-sync-io --description 'Print a stack trace whenever synchronous I/O is… [See Man Page]'
...
complete -c js -l trace-event-categories --description 'A comma separated list of categories that shoul… [See Man Page]'
complete -c js -l zero-fill-buffers --description 'Automatically zero-fills all newly allocated Bu… [See Man Page]'
complete -c js -l preserve-symlinks --description 'Instructs the module loader to preserve symboli… [See Man Page]'
complete -c js -l track-heap-objects --description 'Track heap object allocations for heap snapshots.'
complete -c js -l prof-process --description 'Process V8 profiler output generated using the … [See Man Page]'
complete -c js -l v8-options --description 'Print V8 command line options.'
complete -c js -l v8-pool-size --description 'Set v8\'s thread pool size which will be used to… [See Man Page]'
complete -c js -l tls-cipher-list --description 'Specify an alternative default TLS cipher list.'
complete -c js -l enable-fips --description 'Enable FIPS-compliant crypto at startup.  (Requires Node.'
complete -c js -l force-fips --description 'Force FIPS-compliant crypto on startup.'
complete -c js -l openssl-config --description 'Load an OpenSSL configuration file on startup.'
complete -c js -l use-openssl-ca -l use-bundled-ca --description 'Use OpenSSL\'s default CA store or use bundled M… [See Man Page]'
