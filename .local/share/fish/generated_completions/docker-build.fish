...
complete -c docker-build -l squash --description '   Experimental Only    Once the image is built… [See Man Page]'
complete -c docker-build -l add-host --description '   Add a custom host-to-IP mapping (host:ip) Ad… [See Man Page]'
...
complete -c docker-build -l isolation --description '   Isolation specifies the type of isolation te… [See Man Page]'
...
complete -c docker-build -l compress --description '    Compress the build context using gzip.'
...
complete -c docker-build -s t -l tag --description '   Repository names (and optionally with tags) … [See Man Page]'
...
complete -c docker-build -l network --description '  Set the networking mode for the RUN instructi… [See Man Page]'
