...
complete -c a2ps -s A -l file-align --description 'align separate files according to MODE (fill, r… [See Man Page]'
...
complete -c a2ps -l 'left-title[' --description 'set left and right page title to TEXT .'
complete -c a2ps -l 'left-footer[' --description 'set sheet footers to TEXT . HP --footer[=TEXT] .'
...
complete -c a2ps -l highlight-level --description 'set pretty printing highlight LEVEL LEVEL can b… [See Man Page]'
...
complete -c a2ps -s o -l output --description 'leave output to file FILE.'
...
complete -c a2ps -s d --description 'send output to the default printer (this is the… [See Man Page]'
...
complete -c a2ps -s s -l sides --description 'set the duplex MODE (`1\' or `simplex\', `2\' or `… [See Man Page]'
