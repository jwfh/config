...
complete -c docker-service-update -s d -l 'detach[' --description '    Exit immediately instead of waiting for the… [See Man Page]'
...
complete -c docker-service-update -l group-add --description '    Add an additional supplementary user group … [See Man Page]'
complete -c docker-service-update -l group-rm --description '    Remove a previously added supplementary use… [See Man Page]'
...
complete -c docker-service-update -l health-start-period --description '    Start period for the container to initializ… [See Man Page]'
...
complete -c docker-service-update -l 'no-resolve-image[' --description '    Do not query the registry to resolve image … [See Man Page]'
...
complete -c docker-service-update -l restart-window --description '    Window used to evaluate the restart policy … [See Man Page]'
...
complete -c docker-service-update -l rollback-monitor --description '    Duration after each task rollback to monito… [See Man Page]'
complete -c docker-service-update -l rollback-order --description '    Rollback order ("start-first"|"stop-first").'
complete -c docker-service-update -l rollback-parallelism --description '    Maximum number of tasks rolled back simulta… [See Man Page]'
...
complete -c docker-service-update -l stop-grace-period --description '    Time to wait before force killing a contain… [See Man Page]'
...
complete -c docker-service-update -l update-monitor --description '    Duration after each task update to monitor … [See Man Page]'
complete -c docker-service-update -l update-order --description '    Update order ("start-first"|"stop-first").'
complete -c docker-service-update -l update-parallelism --description '    Maximum number of tasks updated simultaneou… [See Man Page]'
complete -c docker-service-update -s u -l user --description '    Username or UID (format: <name|uid>[:<group|gid>]).'
