...
complete -c apt-cache -l implicit --description 'Per default depends and rdepends print only dep… [See Man Page]'
...
complete -c apt-cache -l names-only -s n --description 'Only search on the package and provided package… [See Man Page]'
