...
complete -c net -s P -l machine-pass --description 'Make queries to the external server using the m… [See Man Page]'
...
complete -c net -s r -l reboot --description 'Reboot a remote machine after a command has bee… [See Man Page]'
complete -c net -l force-full-repl --description 'When calling "net rpc vampire keytab" this opti… [See Man Page]'
complete -c net -l single-obj-repl --description 'When calling "net rpc vampire keytab" this opti… [See Man Page]'
complete -c net -l clean-old-entries --description 'When calling "net rpc vampire keytab" this opti… [See Man Page]'
...
complete -c net -l attrs --description 'Includes file attributes to be copied in "net r… [See Man Page]'
complete -c net -l timestamps --description 'Includes timestamps to be copied in "net rpc share migrate".'
complete -c net -s X -l exclude --description 'Allows to exclude directories when copying with… [See Man Page]'
complete -c net -l destination --description 'Defines the target servername of migration proc… [See Man Page]'
complete -c net -s L -l local --description 'Sets the type of group mapping to local (used i… [See Man Page]'
complete -c net -s D -l domain --description 'Sets the type of group mapping to domain (used … [See Man Page]'
complete -c net -s N -l ntname --description 'Sets the ntname of a group mapping (used in "ne… [See Man Page]'
complete -c net -s R -l rid --description 'Sets the rid of a group mapping (used in "net groupmap set").'
complete -c net -l reg-version --description 'Assume database version {n|1,2,3} (used in "net… [See Man Page]'
complete -c net -s o -l output --description 'Output database file (used in "net registry check").'
complete -c net -l wipe --description 'Create a new database from scratch (used in "ne… [See Man Page]'
complete -c net -l precheck --description 'Defines filename for database prechecking (used… [See Man Page]'
complete -c net -s e -l encrypt --description 'This command line parameter requires the remote… [See Man Page]'
...
complete -c net -l option --description 'Set the smb.'
