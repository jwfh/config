...
complete -c blender -l debug-depsgraph-no-threads --description 'br Switch dependency graph to a single threaded evaluation .'
complete -c blender -l debug-gpumem --description 'br Enable GPU memory stats in status bar . br.'
complete -c blender -l debug-wm --description 'br Enable debug messages for the window manager… [See Man Page]'
...
complete -c blender -l debug-gpu --description 'br Enable gpu debug context and information for OpenGL 4. 3+.'
