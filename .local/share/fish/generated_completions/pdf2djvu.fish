...
complete -c pdf2djvu -l page-id-prefix --description 'Equivalent to \\(lq--page-id-template=prefix{page:04*}.'
...
complete -c pdf2djvu -l media-box --description 'Use MediaBox to determine page size.'
complete -c pdf2djvu -l page-size --description 'Specifies the preferred page size to width pixe… [See Man Page]'
complete -c pdf2djvu -l guess-dpi --description 'Try to guess native resolution by inspecting embedded images.'
...
complete -c pdf2djvu -l fg-colors --description 'Try to preserve all the foreground layer colors.'
complete -c pdf2djvu -l monochrome --description 'Render pages as monochrome bitmaps.  With this option, --bg-.'
...
complete -c pdf2djvu -l anti-alias --description 'Enable font and vector anti-aliasing.'
...
complete -c pdf2djvu -l words --description 'Extract the text.  Record the location of every word.'
complete -c pdf2djvu -l lines --description 'Extract the text.'
complete -c pdf2djvu -l crop-text --description 'Extract no text outside the page boundary.'
complete -c pdf2djvu -l no-nfkc --description 'Do not apply \\m[blue]NFKC\\m[]\\s-2\\u[2]\\d\\s+2 no… [See Man Page]'
...
complete -c pdf2djvu -s j -l jobs --description 'Use n threads to perform conversion.'
complete -c pdf2djvu -o j0 --description 'Determine automatically how many threads to use… [See Man Page]'
complete -c pdf2djvu -s v -l verbose --description 'Display more informational messages while converting the file.'
complete -c pdf2djvu -s q -l quiet --description 'Don\\*(Aqt display informational messages while … [See Man Page]'
...
complete -c pdf2djvu -l 'no-nfkc.' --description '.'
