...
complete -c dpkg -l force-things --description 'TQ  --no-force-things ", " --refuse-things Forc… [See Man Page]'
...
complete -c dpkg -l verify-format --description 'Sets the output format for the --verify command (since dpkg 1.'
...
complete -c dpkg -l merge-avail --description 'Update dpkg\'s and dselect\'s idea of which packa… [See Man Page]'
...
complete -c dpkg -l predep-package --description 'Print a single package which is the target of o… [See Man Page]'
...
complete -c dpkg -l fsys-tarfile --description '    Output the filesystem tar-file contained by… [See Man Page]'
...
complete -c dpkg -l no-force-things -l refuse-things --description 'Force or refuse (no-force and refuse mean the s… [See Man Page]'
