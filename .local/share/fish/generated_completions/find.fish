...
complete -c find -o fstype --description 'FOO predicate and specify a filesystem type FOO… [See Man Page]'
complete -c find -o false --description '3 At this optimisation level, the full cost-bas… [See Man Page]'
...
complete -c find -o depth --description 'option for example makes find traverse the file… [See Man Page]'
complete -c find -o regextype --description 'option for example is positional, specifying th… [See Man Page]'
...
complete -c find -o ls --description 'The + and - prefixes signify greater than and l… [See Man Page]'
complete -c find -o 1M --description 'is not equivalent to.'
complete -c find -o '1048576c.' --description 'The former only matches empty files, the latter… [See Man Page]'
...
complete -c find -o context --description '(SELinux only) Security context of the file mat… [See Man Page]'
...
complete -c find -o 'iregex	3.8' --description 'The syntax . B -perm +MODE was removed in findutils-4. 5.'
