...
complete -c irqbalance -s d -l debug --description 'Causes irqbalance to print extra debug information.'
...
complete -c irqbalance -s p -l powerthresh --description 'Set the threshold at which we attempt to move a… [See Man Page]'
complete -c irqbalance -s i -l banirq --description 'Add the specified IRQ to the set of banned IRQs.'
complete -c irqbalance -l deepestcache --description 'This allows a user to specify the cache level a… [See Man Page]'
complete -c irqbalance -s l -l policyscript --description 'When specified, the referenced script will exec… [See Man Page]'
