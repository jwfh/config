...
complete -c hp-scan -s c -l contrast --description 'The contrast range varies from device to device.'
...
complete -c hp-scan -l duplex -l dup --description 'OPTIONS (SCAN AREA) Specify the units for area/… [See Man Page]'
...
complete -c hp-scan -l size --description 'where <paper size name> is one of: 3x5, 4x6, 5x… [See Man Page]'
...
complete -c hp-scan -o 'x<mode>' -l compression --description 'SEE ALSO AUTHOR HPLIP (HP Linux Imaging and Pri… [See Man Page]'
