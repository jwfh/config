...
complete -c mcs -o fullpaths --description 'Any source code error or warning issued by the … [See Man Page]'
...
complete -c mcs -o sdk:VERSION --description 'Used to specify the version of Base Class Libra… [See Man Page]'
