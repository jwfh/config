...
complete -c mtxrun -l script --description 'run an mtx script (lua prefered method) (--noqu… [See Man Page]'
...
complete -c mtxrun -l locate --description 'locate given filename in database (default) or … [See Man Page]'
...
complete -c mtxrun -l autogenerate --description 'regenerate databases if needed (handy when used… [See Man Page]'
complete -c mtxrun -l usekpse --description 'use kpse as fallback (when no mkiv and cache in… [See Man Page]'
complete -c mtxrun -l forcekpse --description 'force using kpse (handy when no mkiv and cache … [See Man Page]'
...
complete -c mtxrun -l pattern --description 'filter variables AUTHOR More information about … [See Man Page]'
