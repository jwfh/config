...
complete -c gpg2 -l encrypt-to-default-key --description 'If the default secret key is taken from --defau… [See Man Page]'
...
complete -c gpg2 -l print-pka-records --description 'Modify the output of the list commands to print… [See Man Page]'
complete -c gpg2 -l print-dane-records --description 'Modify the output of the list commands to print… [See Man Page]'
...
complete -c gpg2 -l tofu-set-policy --description 'Set the TOFU policy for all the bindings associ… [See Man Page]'
...
complete -c gpg2 -l 'homedir]).' --description '~/. gnupg/pubring. gpg The public keyring.'
