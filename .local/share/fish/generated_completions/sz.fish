...
complete -c sz -s + -l append --description 'Instruct the receiver to append transmitted dat… [See Man Page]'
...
complete -c sz -s b -l binary --description '(ZMODEM) Binary override: transfer file without… [See Man Page]'
complete -c sz -s B -l bufsize --description 'Use a readbuffer of   NUMBER bytes.'
complete -c sz -s c -l command --description 'Send COMMAND to the receiver for execution, ret… [See Man Page]'
complete -c sz -s C -l command-tries --description 'Retry to send command N times (default: 11).'
complete -c sz -s d -l dot-to-slash --description 'Change all instances of ".'
complete -c sz -l delay-startup --description 'Wait  N seconds before doing anything.'
complete -c sz -s e -l escape --description 'Escape all control characters; normally XON, XO… [See Man Page]'
complete -c sz -s E -l rename --description 'Force the sender to rename the new file if a fi… [See Man Page]'
complete -c sz -s f -l full-path --description 'Send Full pathname.'
complete -c sz -s h -l help --description 'give help.'
complete -c sz -s i -l immediate-command --description 'Send COMMAND to the receiver for execution, ret… [See Man Page]'
complete -c sz -s k -l 1k --description '(XMODEM/YMODEM) Send files using 1024 byte bloc… [See Man Page]'
complete -c sz -s L -l packetlen --description 'Use ZMODEM sub-packets of length N.'
complete -c sz -s m -l min-bps --description 'Stop transmission if BPS-Rate (Bytes Per Second… [See Man Page]'
complete -c sz -s M -l min-bps-time --description 'Used together with --min-bps.  Default is 120 (seconds).'
complete -c sz -s l -l framelen --description 'Wait for the receiver to acknowledge correct da… [See Man Page]'
...
complete -c sz -s p -l protect --description '(ZMODEM) Protect existing destination files by … [See Man Page]'
complete -c sz -s q -l quiet --description 'Quiet suppresses verbosity.'
complete -c sz -s R -l restricted --description 'Restricted mode: restricts pathnames to the cur… [See Man Page]'
...
complete -c sz -s S -l timesync --description 'enable timesync protocol support.  See timesync.'
complete -c sz -l 'syslog[' --description 'turn syslogging on or off.'
complete -c sz -s t -l timeout --description 'Change timeout to  TIM tenths of seconds.'
complete -c sz -s T -l turbo --description 'Do not escape certain characters (^P, ^P|0x80, … [See Man Page]'
...
complete -c sz -l tcp-server --description 'Act as a server: Open a socket, print out what … [See Man Page]'
complete -c sz -s u --description 'Unlink the file after successful transmission.'
complete -c sz -s U -l unrestrict --description 'Turn off restricted mode (this is not possible … [See Man Page]'
...
complete -c sz -s y -l overwrite --description 'Instruct a ZMODEM receiving program to overwrit… [See Man Page]'
complete -c sz -s Y -l overwrite-or-skip --description 'Instruct a ZMODEM receiving program to overwrit… [See Man Page]'
