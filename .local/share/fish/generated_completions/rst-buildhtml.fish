...
complete -c rst-buildhtml -l strip-elements-with-class --description 'Remove all elements with classes="<class>" from… [See Man Page]'
complete -c rst-buildhtml -l strip-class --description 'Remove all classes="<class>" attributes from el… [See Man Page]'
complete -c rst-buildhtml -l report -s r --description 'Report system messages at or higher than <level… [See Man Page]'
...
complete -c rst-buildhtml -l halt --description 'Halt execution at system messages at or above <level>.'
complete -c rst-buildhtml -l strict --description 'Halt at the slightest problem.   Same as "--halt=info".'
complete -c rst-buildhtml -l exit-status --description 'Enable a non-zero exit status for non-halting s… [See Man Page]'
...
complete -c rst-buildhtml -l input-encoding -s i --description 'Specify the encoding and optionally the error h… [See Man Page]'
complete -c rst-buildhtml -l input-encoding-error-handler --description 'Specify the error handler for undecodable characters.'
complete -c rst-buildhtml -l output-encoding -s o --description 'Specify the text encoding and optionally the er… [See Man Page]'
complete -c rst-buildhtml -l output-encoding-error-handler --description 'Specify error handler for unencodable output ch… [See Man Page]'
complete -c rst-buildhtml -l error-encoding -s e --description 'Specify text encoding and error handler for error output.'
complete -c rst-buildhtml -l error-encoding-error-handler --description 'Specify the error handler for unencodable chara… [See Man Page]'
...
complete -c rst-buildhtml -l help -s h --description 'Show this help message and exit. UNINDENT .'
complete -c rst-buildhtml -l pep-references --description 'Recognize and link to standalone PEP references… [See Man Page]'
complete -c rst-buildhtml -l pep-base-url --description 'Base URL for PEP references (default "\\%http://www. python.'
complete -c rst-buildhtml -l pep-file-url-template --description 'Template for PEP file part of URL.  (default "pep-%04d").'
complete -c rst-buildhtml -l rfc-references --description 'Recognize and link to standalone RFC references… [See Man Page]'
complete -c rst-buildhtml -l rfc-base-url --description 'Base URL for RFC references (default "\\%http://www. faqs.'
...
complete -c rst-buildhtml -l no-file-insertion --description 'Disable directives that insert the contents of … [See Man Page]'
complete -c rst-buildhtml -l file-insertion-enabled --description 'Enable directives that insert the contents of e… [See Man Page]'
complete -c rst-buildhtml -l no-raw --description 'Disable the "raw" directives; replaced with a "… [See Man Page]'
complete -c rst-buildhtml -l raw-enabled --description 'Enable the "raw" directive.   Enabled by default.'
complete -c rst-buildhtml -l syntax-highlight --description 'Token name set for parsing code with Pygments: … [See Man Page]'
complete -c rst-buildhtml -l smart-quotes --description 'Change straight quotation marks to typographic … [See Man Page]'
...
complete -c rst-buildhtml -l stylesheet-dirs --description 'Comma-separated list of directories where style… [See Man Page]'
complete -c rst-buildhtml -l initial-header-level --description 'Specify the initial header level.   Default is 1 for "<h1>".'
complete -c rst-buildhtml -l field-name-limit --description 'Specify the maximum width (in characters) for o… [See Man Page]'
complete -c rst-buildhtml -l option-limit --description 'Specify the maximum width (in characters) for o… [See Man Page]'
complete -c rst-buildhtml -l footnote-references --description 'Format for footnote references: one of "supersc… [See Man Page]'
complete -c rst-buildhtml -l attribution --description 'Format for block quote attributions: one of "da… [See Man Page]'
complete -c rst-buildhtml -l compact-lists --description 'Remove extra vertical whitespace between items … [See Man Page]'
complete -c rst-buildhtml -l no-compact-lists --description 'Disable compact simple bullet and enumerated lists.'
complete -c rst-buildhtml -l compact-field-lists --description 'Remove extra vertical whitespace between items … [See Man Page]'
complete -c rst-buildhtml -l no-compact-field-lists --description 'Disable compact simple field lists.'
complete -c rst-buildhtml -l table-style --description 'Added to standard table classes.  Defined styles: "borderless".'
complete -c rst-buildhtml -l math-output --description 'Math output format, one of "MathML", "HTML", "M… [See Man Page]'
complete -c rst-buildhtml -l no-xml-declaration --description 'Omit the XML declaration.   Use with caution.'
complete -c rst-buildhtml -l cloak-email-addresses --description 'Obfuscate email addresses to confuse harvesters… [See Man Page]'
complete -c rst-buildhtml -l python-home --description 'Python\\(aqs home URL.   Default is "\\%http://www. python. org".'
complete -c rst-buildhtml -l pep-home --description 'Home URL prefix for PEPs.   Default is ".'
complete -c rst-buildhtml -l recurse --description 'Recursively scan subdirectories for files to process.'
complete -c rst-buildhtml -l local --description 'Do not scan subdirectories for files to process.'
complete -c rst-buildhtml -l prune --description 'Do not process files in <directory> (shell glob… [See Man Page]'
complete -c rst-buildhtml -l ignore --description 'Recursively ignore files matching any of the gi… [See Man Page]'
complete -c rst-buildhtml -l silent --description 'Work silently (no progress messages).'
complete -c rst-buildhtml -l 'stylesheet-dirs.' --description 'rewritten relative to the output HTML file.'
