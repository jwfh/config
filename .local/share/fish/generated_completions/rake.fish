...
complete -c rake -s j -l jobs --description 'Specifies the maximum number of tasks to execut… [See Man Page]'
...
complete -c rake -s G -l no-system -l nosystem --description 'Use standard project Rakefile search paths, ign… [See Man Page]'
complete -c rake -s R -l rakelibdir --description 'Auto-import any .'
complete -c rake -s g -l system --description 'Using system wide (global) rakefiles (usually \'~/. rake/*.'
...
complete -c rake -l suppress-backtrace --description 'Suppress backtrace lines matching regexp PATTERN.'
...
complete -c rake -s T -l tasks --description 'Display the tasks (matching optional PATTERN) w… [See Man Page]'
...
complete -c rake -s E -l execute-continue --description 'Execute some Ruby code, then continue with norm… [See Man Page]'
...
complete -c rake -s s -l silent --description 'Like --quiet, but also suppresses the \'in direc… [See Man Page]'
...
complete -c rake -s A -l all --description 'Show all tasks, even uncommented ones (in combi… [See Man Page]'
complete -c rake -l job-stats --description 'Display job statistics.'
