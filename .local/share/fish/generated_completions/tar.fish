...
complete -c tar -o '\\-clamp\\-mtime' --description 'only set time when the file is more recent than… [See Man Page]'
...
complete -c tar -o '\\-exclude\\-ignore' --description 'read exclude patterns for each directory from F… [See Man Page]'
complete -c tar -o '\\-exclude\\-ignore\\-recursive' --description 'read exclude patterns for each directory and it… [See Man Page]'
...
complete -c tar -o '\\-sort' --description 'directory sorting order: none (default), name o… [See Man Page]'
